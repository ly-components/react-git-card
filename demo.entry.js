...
/******/ 	var hotCurrentHash = "77dc686c0758ec381db5"; // eslint-disable-line no-unused-vars
	  ...
	  _createClass(Icon, [{
	    ...
	    value: function render() {
	      ...
	      if (type === 'repos') return _react2['default'].createElement(
	        'svg',
	        { 'enable-background': 'new 0 0 16 16', height: '16px', id: '图形', version: '1.1', viewBox: '0 0 1024 1024', width: '16px', x: '0px', xmlns: 'http://www.w3.org/2000/svg', y: '0px' },
