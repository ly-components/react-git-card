...
/******/ 	var hotCurrentHash = "a077c660fcfa0aabaa0e"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_srcIndex2['default'], { user: 'LingyuCoder' }), document.getElementById('demo'));
	...
	var Component = (function (_React$Component) {
	  ...
	  _createClass(Component, [{
	    ...
	    value: function componentWillReceiveProps(props) {
	      if (props.user && props.user !== this.props.user) this._fetchUserInfo(props.user);
	    }
	  }, {
	    key: '_fetchUserInfo',
	    value: function _fetchUserInfo(user) {
	      var _this = this;
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'react-git-card' },
	        _react2['default'].createElement(
	          'a',
	          { href: data.html_url },
	          data.avatar_url ? _react2['default'].createElement('img', { alt: 'avatar', className: 'react-git-card-avatar', src: data.avatar_url }) : _react2['default'].createElement('span', { className: 'react-git-card-avatar' })
	        ),
	        _react2['default'].createElement(
	          'h1',
	          { className: 'react-git-card-name' },
	          data.name
	        ),
	        _react2['default'].createElement(
	          'p',
	          { className: 'react-git-card-desc' },
	          data.login
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'react-git-card-social' },
	          _react2['default'].createElement(
	            'a',
	            { className: 'react-git-card-item followers', href: 'https://github.com/' + user + '/followers' },
	            _react2['default'].createElement(
	              'span',
	              { className: 'react-git-card-icon' },
	              _react2['default'].createElement(_Icon2['default'], { type: 'followers' })
	            ),
	            data.followers
	          ),
	          _react2['default'].createElement(
	            'a',
	            { className: 'react-git-card-item repos', href: 'https://github.com/' + user + '?tab=repositories' },
	            _react2['default'].createElement(
	              'span',
	              { className: 'react-git-card-icon' },
	              _react2['default'].createElement(_Icon2['default'], { type: 'repos' })
	            ),
	            data.public_repos
	          ),
	          _react2['default'].createElement(
	            'a',
	            { className: 'react-git-card-item following', href: 'https://github.com/' + user + '/following' },
	            _react2['default'].createElement(
	              'span',
	              { className: 'react-git-card-icon' },
	              _react2['default'].createElement(_Icon2['default'], { type: 'following' })
	            ),
	            data.following
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Icon = (function (_React$Component) {
	  ...
	  _createClass(Icon, [{
	    ...
	    value: function render() {
	      ...
	      if (type === 'repos') return _react2['default'].createElement(
	        'svg',
	        { 'enable-background': 'new 0 0 16 16', height: '16px', version: '1.1', viewBox: '0 0 1024 1024', width: '16px', x: '0px', xmlns: 'http://www.w3.org/2000/svg', y: '0px' },
	        _react2['default'].createElement('path', { d: 'M1021.504 617.824c-2.88 6.848-8.768 11.968-15.936 13.888L557.12 747.232C545.536 750.176 533.76 744.16 529.344 733.216l-79.04-194.56C448.768 534.944 448.576 531.104 448.96 527.392L387.712 513.056 386.304 515.04C383.872 518.304 380.608 520.864 376.896 522.528L33.344 674.528c-9.664 4.288-21.12 1.6-27.84-6.656C-1.216 659.68-1.664 647.968 4.416 639.264l121.856-173.248 0-328.512c0-8.128 4.288-15.744 11.264-20.032l348.032-214.4c3.84-2.24 8.064-3.52 12.416-3.52 2.816 0 5.696 0.512 8.448 1.472l377.024 144.384c9.216 3.648 15.104 12.352 15.104 22.144L898.56 391.072l121.344 205.696C1023.808 603.168 1024.384 610.976 1021.504 617.824zM854.656 409.504c-2.176-3.648-3.2-7.808-3.2-12.032l0-313.472-350.976-134.4L173.568 150.752 173.568 473.504c0 4.864-1.472 9.664-4.288 13.568L92.16 596.768 352.128 481.76l71.296-95.36L246.592 467.616c-11.904 5.504-25.92 0.192-31.36-11.584C209.792 444.064 214.976 430.112 226.88 424.608L474.368 310.88l0-282.112c0-13.12 10.624-23.616 23.68-23.616 13.056 0 23.616 10.496 23.616 23.616L521.664 325.6l0 0L521.664 325.984c0 0.384-0.192 0.768-0.192 1.024 0 1.344-0.256 2.624-0.512 4.032l328.256 71.04-348.224 135.68 64.384 158.528 397.888-102.528L854.656 409.504z', fill: '#fff', transform: 'translate(0, 812) scale(1, -1)' })
	      );else if (type === 'followers') return _react2['default'].createElement(
	        'svg',
	        { 'enable-background': 'new 0 0 16 16', height: '16px', version: '1.1', viewBox: '0 0 1024 1024', width: '16px', x: '0px', xmlns: 'http://www.w3.org/2000/svg', y: '0px' },
	        _react2['default'].createElement('path', { d: 'M734.389508 290.126118c40.928155 48.365544 65.548902 110.321618 65.548902 177.837314 0 154.592914-128.910998 279.941783-287.938921 279.941783S224.05852 622.55737 224.05852 467.964456c0-67.51672 24.622794-129.47177 65.550948-177.837314-75.172073-22.74605-129.536238-84.543511-129.536238-158.091598l0-111.976304c0-92.76066 85.951581-167.964456 191.959963-167.964456l319.93259 0c106.008382 0 191.959963 75.202773 191.959963 167.964456L863.925746 132.034521C863.925746 205.582607 809.562605 267.381092 734.389508 290.126118zM288.04688 467.964456c0 123.67781 100.260471 223.954655 223.952608 223.954655s223.952608-100.276844 223.952608-223.954655S635.691625 244.012871 511.999488 244.012871 288.04688 344.285622 288.04688 467.964456zM799.93841 34.054999c0-69.578682-70.329788-125.973086-157.060105-125.973086L381.120672-91.918088c-86.732363 0-157.062152 56.393381-157.062152 125.973086l0 83.98274c0 59.517535 51.615565 109.072161 120.789017 122.257461 47.176462-32.777521 104.757902-52.270481 167.151951-52.270481 62.393026 0 119.973442 19.49296 167.152974 52.270481 69.172429-13.1853 120.785947-62.739926 120.785947-122.257461L799.93841 34.054999z', fill: '#fff', transform: 'translate(0, 812) scale(1, -1)' })
	      );else return _react2['default'].createElement(
	        'svg',
	        { 'enable-background': 'new 0 0 16 16', height: '16px', version: '1.1', viewBox: '0 0 1024 1024', width: '16px', x: '0px', xmlns: 'http://www.w3.org/2000/svg', y: '0px' },
	        _react2['default'].createElement('path', { d: 'M749.624889-168.152889c-15.672889 0-31.246222 3.882667-45.084444 11.306667l-192.526222 103.637333L319.544889-156.817778c-31.203556-16.64-70.314667-14.392889-99.043556 5.304889-29.511111 20.337778-44.743111 55.921778-38.840889 90.695111l37.703111 225.251556L56.661333 326.908444c-25.002667 24.888889-33.464889 60.984889-22.058667 94.193778 11.349333 32.910222 40.064 56.576 74.965333 61.752889l221.326222 32.896 96.128 199.580444c15.488 32.085333 48.853333 52.807111 84.992 52.807111 36.167111 0 69.518222-20.736 84.963556-52.807111l96.156444-199.580444 221.297778-32.910222c34.872889-5.162667 63.616-28.8 74.979556-61.696 11.392-33.28 2.944-69.361778-22.030222-94.250667L804.622222 164.433778l37.745778-225.28c5.845333-34.773333-9.386667-70.357333-38.812444-90.638222C787.569778-162.392889 768.938667-168.152889 749.624889-168.152889zM512.014222 7.548444c4.636444 0 9.272889-1.137778 13.482667-3.384889l205.937778-110.862222c12.373333-6.641778 28.316444-5.802667 39.936 2.133333 11.392 7.836444 17.123556 21.006222 14.890667 34.304L746.097778 169.496889c-1.507556 9.088 1.450667 18.332444 7.964444 24.832l173.141333 172.842667c9.457778 9.429333 12.686222 23.025778 8.405333 35.484444-4.380444 12.672-15.701333 21.873778-29.525333 23.921778L669.866667 461.706667c-9.315556 1.379556-17.365333 7.296-21.447111 15.786667L545.720889 690.641778c-6.030222 12.529778-19.256889 20.608-33.706667 20.608s-27.690667-8.092444-33.763556-20.622222L375.608889 477.493333c-4.081778-8.490667-12.131556-14.407111-21.447111-15.786667L117.930667 426.577778c-13.624889-2.033778-25.201778-11.434667-29.539556-23.992889-4.266667-12.416-1.024-25.984 8.433778-35.399111L269.937778 194.328889c6.513778-6.499556 9.472-15.744 7.964444-24.832l-40.135111-239.744c-2.247111-13.312 3.484444-26.439111 14.976-34.360889 11.434667-7.836444 27.349333-8.775111 39.950222-2.062222l205.852444 110.833778C502.741333 6.410667 507.377778 7.548444 512.014222 7.548444zM200.32 355.210667c-6.840889 0-12.885333 4.963556-14.023111 11.946667-1.251556 7.751111 4.010667 15.061333 11.761778 16.312889l9.443556 1.536c7.793778 1.336889 15.061333-4.010667 16.312889-11.761778 1.251556-7.751111-4.010667-15.061333-11.761778-16.312889l-9.443556-1.536C201.856 355.267556 201.073778 355.210667 200.32 355.210667zM252.544 363.687111c-6.684444 0-12.643556 4.721778-13.937778 11.534222-1.493333 7.708444 3.555556 15.175111 11.264 16.654222l153.927111 29.696 58.055111 133.148444c3.157333 7.182222 11.548444 10.496 18.716444 7.352889 7.210667-3.143111 10.510222-11.52 7.367111-18.716444l-61.056-140.017778c-1.877333-4.295111-5.745778-7.395556-10.353778-8.277333l-161.28-31.118222C254.336 363.758222 253.44 363.687111 252.544 363.687111z', fill: '#fff', transform: 'translate(0, 812) scale(1, -1)' })
	      );
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
	      type: _react2['default'].PropTypes.oneOf(['repos', 'followers', 'following'])
	    },
	    enumerable: true
	  }, {
	    key: 'defaultProps',
	...
	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Icon.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".react-git-card {\n  width: 300px;\n  border-radius: 5px;\n  font-size: 18px;\n  color: #fff;\n  background: #394264;\n  overflow: hidden;\n}\n.react-git-card .react-git-card-avatar {\n  display: block;\n  width: 150px;\n  height: 150px;\n  border-radius: 50%;\n  border: 5px solid #50597b;\n  margin: 40px auto 30px;\n}\n.react-git-card .react-git-card-name {\n  text-align: center;\n  font-size: 24px;\n  margin: 0;\n  font-weight: bolder;\n}\n.react-git-card .react-git-card-desc {\n  margin: 20px 0 30px;\n  font-size: 16px;\n  color: #9099b7;\n  text-align: center;\n}\n.react-git-card .react-git-card-social {\n  overflow: hidden;\n  background: #50597b;\n}\n.react-git-card .react-git-card-social .react-git-card-item {\n  float: left;\n  height: 60px;\n  width: 33%;\n  text-align: center;\n  line-height: 60px;\n  margin-right: 1px;\n  background: #394264;\n}\n.react-git-card .react-git-card-social .react-git-card-item .react-git-card-icon {\n  margin-right: 8px;\n}\n.react-git-card .react-git-card-social .react-git-card-item.followers {\n  box-shadow: inset 0 5px 0 #cc324b;\n}\n.react-git-card .react-git-card-social .react-git-card-item.repos {\n  box-shadow: inset 0 5px 0 #11a8ab;\n}\n.react-git-card .react-git-card-social .react-git-card-item.following {\n  box-shadow: inset 0 5px 0 #fcb150;\n}\n.react-git-card .react-git-card-social .react-git-card-item:hover {\n  background: #50597b;\n}\n.react-git-card .react-git-card-social .react-git-card-item:last-child {\n  margin-right: 0;\n}\n.react-git-card a {\n  color: #fff;\n  text-decoration: none;\n}\n", ""]);
